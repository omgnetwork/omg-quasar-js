...
describe('Quasar Fast Exit test', () => {
  ...
  describe('When a Fast Exit is started', () => {
    ...
    it('should return back liquid funds', async () => {
      ...
      let aliceEthBalanceBeforeClaim = await web3.eth.getBalance(aliceAccount.address);
      ...
      if (claimTxAfter) {
        ...
        aliceSpentOnGas = await rcHelper.spentOnGas(web3, claimTxAfter);
